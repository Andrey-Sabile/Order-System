...
export interface ITablesClient {
    ...
    createTable(command: CreateTableCommand): Observable<number>;
}
...
export class TablesClient implements ITablesClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<TableDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<TableDto[]>;
        }));
    }

    protected processGetTables(response: HttpResponseBase): Observable<TableDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    createTable(command: CreateTableCommand): Observable<number> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateTable(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<number>;
                }
            } else
